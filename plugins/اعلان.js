...
let fakegif = { key: {participant: `0@s.whatsapp.net`, ...("967778088098@g.us" ? { remoteJid: "967778088098@g.us" } : {})},message: {"videoMessage": { "title": '𝐒𝐇𝐀𝐃𝐎𝐖', "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': '𝐒𝐇𝐀𝐃𝐎𝐖', 'jpegThumbnail': false }}}
let teks = `*✨️ • الجروب:* ${groupMetadata.subject}\n*🍀 • من:* ${name}\n*🍁 • رقم المطور:* wa.me/${who.split`@`[0]}\n*🗿 • الرساله:* ${text}`
