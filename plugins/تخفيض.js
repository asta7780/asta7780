...
conn.reply(m.chat, `*[ ✅ ] تم تنزيله من الاشـراف*`, m)
}}
handler.help = ['*967778088098xxx*','*@اسم المستخدم*','*محادثة المستجيب*'].map(v => 'demote ' + v)
handler.tags = ['group']
handler.command = /^(خفض|إزالة المشرف|ازالة |تخفيض|انزال)$/i
handler.group = true
handler.admin = true
