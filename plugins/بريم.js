const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  if (command == 'بريم1' || command == 'userpremium') {
...
handler.help = ['بريم1 [@user] <days>'];
handler.tags = ['owner'];
handler.command = ['بريم1', 'userpremium', 'بريم2', 'userpremium2', 'بريم3', 'userpremium3', 'بريم4', 'userpremium4'];
handler.group = true;
handler.rowner = true;
